...
//  Habits
//
//  Created by Павло Пастернак on 27.05.2022.
//
...
class LogHabitCollectionViewController: HabitCollectionViewController {
    ...
    override func createLayout() -> UICollectionViewCompositionalLayout {
        return UICollectionViewCompositionalLayout { (sectionIndex,cenvironment) -> NSCollectionLayoutSection? in
            if sectionIndex == 0 && self.model.favoriteHabits.count > 0 {
                ...
                let sectionHeader =
                NSCollectionLayoutBoundarySupplementaryItem(layoutSize: headerSize, elementKind: SectionHeader.kind.identifier, alignment: .top)
